...
class NeuralNetwork(object):
    ...
    def train(self, features, targets):
        ...
        #Modified for Vector Computation
        X=features
        y=targets
        ###############################
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        hidden_error = self.weights_hidden_to_output*error.squeeze()*hidden_outputs*(1-hidden_outputs)
        output_error_term = error 
        
        ##Modified for vector computation
        X=X.T
        ####################
        hidden_error_term = np.dot(X,hidden_error.T)
